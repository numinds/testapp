...
//bd var utilities = require('laravel-elixir/ingredients/commands/Utilities');
...
//b    src = utilities.prefixDirToFiles(options.baseDir, src);
//b
//b    gulp.task("cache-busting", function() {
//b        return gulp.src( src, {base: './public'} )
//b            .pipe(cacheBust(options))
//b            .pipe(gulp.dest(options.baseDir));
//b    });
//b
//b    this.registerWatcher("cache-busting",src);

//b    return this.queueTask("cache-busting");
